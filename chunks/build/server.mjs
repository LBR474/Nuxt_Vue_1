import { version, ref, watchEffect, watch, getCurrentInstance, unref, inject, useSSRContext, createApp, effectScope, reactive, mergeProps, hasInjectionContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent } from 'vue';
...
import { d as useRuntimeConfig$1, l as sanitizeStatusCode, m as createHooks, h as createError$1, t as toRouteMatcher, n as createRouter } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-BVHRT2Y7.mjs');
...
const unhead_cf1pBrzajx = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_HCBcak1cO5 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_aJCAG1Xjfq = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_cf1pBrzajx,
  router_HCBcak1cO5,
  revive_payload_server_aJCAG1Xjfq,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BNUZ2tB8.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-rq7HSjjG.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.7_floating-vue@5.2.2_unocss@0.58.7_vite@5.2.6/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.7_floating-vue@5.2.2_unocss@0.58.7_vite@5.2.6/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, parseQuery as a, useRuntimeConfig as b, withoutTrailingSlash as c, useHead as d, entry$1 as default, br as e, hasProtocol as h, joinURL as j, navigateTo as n, parseURL as p, useRouter as u, withTrailingSlash as w };
